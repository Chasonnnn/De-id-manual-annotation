...
def test_methods_cli_run_accepts_v2_method_bundle(monkeypatch, capsys):
    captured: dict[str, object] = {}
...
def test_manifest_methods_run_accepts_v2_method_bundle(monkeypatch, tmp_path):
    captured: dict[str, object] = {}
    ...
    manifest_path = tmp_path / "methods_manifest_v2.yaml"
    manifest_path.write_text(
        "\n".join(
            [
                "kind: methods_lab",
