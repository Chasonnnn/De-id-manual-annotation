...
describe("MetricsPanel", () => {
  it("uses the NAME-tolerant exact companion metrics as the primary display when exact mode is selected", () => {
    ...
    expect(screen.getByText("NAME-Tolerant Micro F1")).not.toBeNull();
